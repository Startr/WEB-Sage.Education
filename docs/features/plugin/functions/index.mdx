...
### 1. **Install Functions**  
You can install Functions via the Sage WebUI interface or by importing them manually. You can find community-created functions on the [Sage WebUI Community Site](https://sage.education/functions).

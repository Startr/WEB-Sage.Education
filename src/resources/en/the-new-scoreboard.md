...
*This is Part 2 of a two-part series. [Part 1, "The Wrong Scoreboard,"](/blog/the-wrong-scoreboard/) examined why grades and standardized test scores were always the wrong metric — and how AI proved it.*
...
![[painting-geographer-vermeer.jpg]]
...
![[painting-young-girl-reading-fragonard.jpg]]
...
![[painting-scholar-rembrandt.jpg]]
...
Part of the answer is legal inertia, documented in [Part 1](/blog/the-wrong-scoreboard/). Part of it is a thirty-nine-billion-dollar industry with no incentive to replace itself. But there is a third obstacle, and it is the one that matters most for what comes next: AI has made the learning process invisible.
...
This is the paradox that [Part 1](/blog/the-wrong-scoreboard/) identified: Gruner proved that removing grades makes students engage with learning. Engel proved that the system extinguishes curiosity. Hurley proved that grading output is grading background. The research proves that curiosity can be measured and that schools measuring it outperform schools that do not. But AI has made the learning process invisible at the exact moment when visibility into that process is the thing educators need most.
...
The question from [Part 1](/blog/the-wrong-scoreboard/) was: if the scoreboard is wrong, what is the right one?
...
[^1]: Sophie von Stumm, Benedikt Hell, and Tomas Chamorro-Premuzic, "The Hungry Mind: Intellectual Curiosity Is the Third Pillar of Academic Performance," *Perspectives on Psychological Science* 6, no. 6 (2011): 574–588. [APS summary](https://www.psychologicalscience.org/news/intellectual-curiosity-predicts-academic-success-study-finds.html).

[^2]: Todd Kashdan et al., "The Five-Dimensional Curiosity Scale: Capturing the Bandwidth of Curiosity and Identifying Four Unique Subgroups of Curious People," *Journal of Research in Personality* 73 (2018): 130–149. [Five-Dimensional Curiosity Scale overview](https://toddkashdan.medium.com/what-are-the-five-dimensions-of-curiosity-7de73684d53a).

[^3]: Todd Kashdan et al., "The Five-Dimensional Curiosity Scale Revised (5DCR): Briefer Subscales While Separating Overt and Covert Social Curiosity," *Personality and Individual Differences* 157 (2020). [ScienceDirect](https://www.sciencedirect.com/science/article/abs/pii/S019188692030026X).

[^4]: Jamie Jirout et al., "Development and Testing of the Curiosity in Classrooms Framework and Coding Protocol," *Frontiers in Psychology* 13 (2022). [Frontiers](https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2022.875161/full).

[^5]: Jirout et al., "Development and Testing of the Curiosity in Classrooms Framework."

[^6]: Stanford SPARK Lab, MAGIC Project (Measuring Acquisition and Growth of Inquiry and Curiosity). Preliminary findings presented at SRCD 2025. [Stanford SPARK Lab – Studies](https://sparklab.stanford.edu/studies).

[^7]: Ministry of Education, Singapore, "Removal of Mid-Year Exams Will Help Nurture Joy for Learning," [MOE Singapore](https://www.moe.gov.sg/news/forum-letter-replies/20220317-removal-of-mid-year-exams-will-help-nurture-joy-for-learning), March 2022.

[^8]: OECD, "New PISA Results on Creative Thinking," [OECD](https://www.oecd.org/en/publications/new-pisa-results-on-creative-thinking_b3a46696-en.html).

[^9]: "Abolishing Mid-Year Exams for Young Learners Frees Up Time for More Creative Pursuits," [The Independent Singapore](https://theindependent.sg/abolishing-mid-year-exams-for-young-learners-frees-up-time-for-more-creative-pursuits/).

[^10]: Ministry of Education, Singapore, "Effect of Removing Mid-Year Examinations," [MOE Singapore](https://www.moe.gov.sg/news/parliamentary-replies/20231003-effect-of-removing-mid-year-examinations), October 2023.

[^11]: "Why New Zealand? A Primer on the NZ Education System," [Aurora Institute](https://aurora-institute.org/cw_post/why-new-zealand/). New Zealand ranked 5th out of 81 countries in creative thinking, PISA 2022.

[^12]: "South Korea's Educational Leap Forward: Fostering Reforms in Pedagogy and Curriculum Through Digitalization and Innovation," [Springer](https://link.springer.com/chapter/10.1007/978-981-97-3068-1_8).

[^13]: "The Mastery Transcript Consortium Has Been Developing a Gradeless Transcript for College Admissions," [The 74](https://www.the74million.org/article/the-mastery-transcript-consortium-has-been-developing-a-gradeless-transcript-for-college-admissions-this-fall-it-gets-its-first-test/). As of July 2025, 701 colleges and universities accept MTC Learning Records.

[^14]: "What If There Were No Grades?" *Educational Assessment, Evaluation and Accountability*, 2025. [Springer](https://link.springer.com/article/10.1007/s11092-025-09468-7).

[^15]: Amir Nathoo, "Outschool: Passion, Not Curriculum, Is the Future of Education," [Self-Directed Podcast, Episode 119](https://www.selfdirectedpodcast.com/2103333/episodes/17111829-119-amir-nathoo-outschool-passion-not-curriculum-is-the-future-of-education).

[^16]: Nathoo, Self-Directed Podcast. See also: "Redefining Education in the Age of AI with Amir Nathoo," [The Eric Ries Show](https://www.ericriesshow.com/amir-nathoo-outschool/).

[^17]: Ignite Learning Academy, [Meet the Team](https://ignitelearningacademy.com/about/meet-the-team). Ranked top online school in Arizona by Niche.com for three consecutive years.

[^18]: Sage.Education is an open-source (AGPL-3), self-hostable, model-agnostic AI platform built by Startr LLC. FERPA, COPPA, and GDPR compliant. Student data stays under school control. [sage.education](https://sage.education/).
...
- [Don't Panic](/blog/dont-panic/) — A Montreal girls' school built its own AI. Then its students built on top of it. What happens when students are builders, not users.
- [Whose AI, On Whose Terms](/blog/whose-ai-on-whose-terms/) — A playbook for any school, board, or parent who wants to start building with AI instead of hiding from it.
...
- [Why AI Must Show Its Work](/blog/why-ai-must-show-its-work/) — The earlier, shorter case for process visibility — the seed that grew into this article's Black Box section.

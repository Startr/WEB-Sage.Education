...
rating: 5
hero: /assets/images/heroes/hero-wrong-scoreboard.jpg
hero_alt: "An empty classroom with rows of desks and a chalkboard, late afternoon light falling across unmarked papers"
...
*This is Part 1 of a two-part series. [Part 2, "The New Scoreboard,"](/blog/the-new-scoreboard/) examines what should replace grades and test scores.*
...
![[painting-schulexamen-anker.jpg]]
...
![[painting-young-student-chardin.jpg]]
...
The question is what [the new scoreboard](/blog/the-new-scoreboard/) should look like — what it would measure, who is already building it, and why AI makes it possible for the first time.

## Footnotes

[^1]: Elisabeth Gruner, "I No Longer Grade My Students' Work – And I Wish I Had Stopped Sooner," [The Conversation](https://theconversation.com/i-no-longer-grade-my-students-work-and-i-wish-i-had-stopped-sooner-179617), April 20, 2022.

[^2]: Gruner, "I No Longer Grade My Students' Work."

[^3]: The article was distributed by the Associated Press and appeared in more than forty outlets including PBS NewsHour, Channel News Asia, Yahoo Finance, Slashdot, and The Tyee. See also: "Why This Professor No Longer Grades Her Students' Work," [PBS NewsHour](https://www.pbs.org/newshour/education/why-this-professor-no-longer-grades-her-students-work-and-wishes-she-had-stopped-sooner).

[^4]: Guy Kawasaki, "Elisabeth Gruner: The Zen of Writing, Reading, and Learning," [Remarkable People podcast](https://guykawasaki.com/elisabeth-gruner-the-zen-of-writing-reading-and-learning/).

[^5]: "Ungrading," [University of Richmond Magazine](https://magazine.richmond.edu/article/-/22250/ungrading.html).

[^6]: GPT-4 exam performance: Semafor, "Here's How GPT-4 Scored on the GRE, LSAT, AP English, and Other Exams," [Semafor](https://www.semafor.com/article/03/15/2023/how-gpt-4-performed-in-academic-exams), March 15, 2023. Bar exam re-evaluation: Eric Martinez and Christoph Moller, "Re-Evaluating GPT-4's Bar Exam Performance," [Artificial Intelligence and Law](https://link.springer.com/article/10.1007/s10506-024-09396-9), 2024.

[^7]: K-12 standardized testing market: "It's a $1.7 Billion Testing Market," [EdWeek Market Brief](https://marketbrief.edweek.org/marketplace-k-12/its_17_billion_testing_market_but_its_a_600_billion_ed_system/). Broader industry: "Testing & Educational Support in the US," [IBISWorld](https://www.ibisworld.com/united-states/industry/testing-educational-support/1549/), 2026.

[^8]: College Board, "A Values-Driven Approach to AI in the Classroom," [College Board All Access](https://allaccess.collegeboard.org/values-driven-approach-ai-classroom).

[^9]: Joanna Gorin, quoted in "Will AI Transform Standardized Testing?" [Education Week](https://www.edweek.org/technology/will-ai-transform-standardized-testing/2024/12), December 2024.

[^10]: "Federal Education Policy 101: State Assessments," [Bipartisan Policy Center](https://bipartisanpolicy.org/explainer/federal-education-policy-101-state-assessments/). See also: "ESSA and Testing," [National Education Association](https://www.nea.org/resource-library/essa-and-testing).

[^11]: Susan Engel, *The Hungry Mind: The Origins of Curiosity in Childhood*, Harvard University Press, 2015. [ISBN 978-0-674-73675-7](https://en.wikipedia.org/wiki/Special:BookSources/978-0-674-73675-7).

[^12]: Susan Engel, "Children's Need to Know: Curiosity in Schools," *Harvard Educational Review* 81, no. 4 (2011): 625–645. [PDF](https://elimindset.com/wp-content/uploads/2022/08/engel2011.pdf).

[^13]: Engel, "Children's Need to Know." See also: "All Learning, No Questioning: How Schools Smother Curiosity," [Education Week](https://www.edweek.org/teaching-learning/opinion-all-learning-no-questioning-how-schools-smother-curiosity/2024/09), September 2024.

[^14]: Engel, "Children's Need to Know."

[^15]: "Generative AI in Universities: Grades Up, Signals Down, Skills in Flux," Centre for Economic Policy Research (CEPR), June 2025. Tracked 36,000 students across 6,000 courses at a leading Israeli university, 2018–2024. AI raises grades especially for lower-performing students, compresses grade distribution, and erodes the signal value of grades for employers. [CEPR VoxEU](https://cepr.org/voxeu/columns/generative-ai-universities-grades-signals-down-skills-flux)

[^16]: "Ohlone College Honors Professor Jen Hurley and the Transformative Power of Education for Non-Traditional Students," [Ohlone College](https://www.ohlone.edu/article/announcement/ohlone-college-honors-professor-jen-hurley-and-transformative-power-education).

[^17]: Jennifer Hurley, "I Stopped Grading. You Can, Too," [Medium](https://profhurley.medium.com/i-stopped-grading-you-can-too-33f155911f4e). See also: "Why I Had to Give Up Grades or Give Up Teaching," [Medium](https://medium.com/@profhurley/why-i-had-to-give-up-grades-or-give-up-teaching-3391231b6049).

[^18]: Gruner, "I No Longer Grade My Students' Work."

[^19]: Jordan Usdan, Allison Connell Pensky, and Harley Chang, "Generative AI's Impact on Graduate Student Professional Writing Productivity and Quality," *International Journal of Artificial Intelligence in Education*, 2025. GenAI reduced writing time by 57% and improved quality from A- to A, with the largest gains among ESL students. [Springer](https://link.springer.com/article/10.1007/s40593-025-00528-z) | [CMU Heinz College](https://www.heinz.cmu.edu/media/2024/September/study-finds-generative-ai-significantly-boosts-graduate-level-writing-efficiency-and-quality)

[^20]: "Study Explores AI-Written Admissions Essays," *Inside Higher Ed*, May 2026. Analysis of tens of thousands of admissions essays at a selective US college found measurably increased homogeneous language after AI tools became available in 2022, with the most convergence among lower-income students and rejected applicants. [Inside Higher Ed](https://www.insidehighered.com/news/admissions/traditional-age/2026/05/08/study-explores-ai-written-admissions-essays)

---

*This is Part 1 of a two-part series. [Part 2, "The New Scoreboard,"](/blog/the-new-scoreboard/) examines what should replace grades and test scores — the research that proves curiosity can be measured, the schools and countries already doing it, and the tools that make the learning process visible in an AI-mediated world.*

## Further Reading

- [Don't Panic](/blog/dont-panic/) — A Montreal girls' school built its own AI. Then its students built on top of it. The positive case for what the new scoreboard would measure.
- [The Builders You'd Ban](/blog/the-builders-youd-ban/) — Canada is moving to ban AI for anyone under sixteen. The students who would be banned are the ones already building with it.
- [We've Been Here Before](/blog/we-have-been-here-before/) — Every generation panics about a new technology and its children. Every generation is wrong in the same way.
- [Why AI Must Show Its Work](/blog/why-ai-must-show-its-work/) — The case for process visibility in AI education — the argument that becomes the foundation of Part 2.

---

*The views expressed are those of the editorial board and do not necessarily reflect the positions of any institution mentioned. Sage.is and Sage.Education are products of Startr LLC; their inclusion represents a disclosure of interest. No individuals quoted in this article were interviewed; all quotes are from published sources. Full disclosure and transparency is a feature, not a bug.*
